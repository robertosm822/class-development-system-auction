                ...
                <div class="col-lg-8">
                    <div class="dashboard-widget mb-40">
                        <div class="dashboard-title mb-30">
                            <h5 class="title">Minha Atividade</h5>
                        </div>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="dashboard-item">
                                    ...
                                    <div class="content">
                                        ...
                                        <h6 class="info">Lances ativos</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6">
                    ...
                    <div class="dashboard-widget">
                        <h5 class="title mb-10">Compras / Lances</h5>
                        <div class="dashboard-purchasing-tabs">
                            <ul class="nav-tabs nav">
                                <li>
                                    <a href="#current" class="active" data-toggle="tab">Atuais</a>
                                </li>
                                <li>
                                    <a href="#pending" data-toggle="tab">Pendentes</a>
                                </li>
                                <li>
                                    <a href="#history" data-toggle="tab">Histórico</a>
                                </li>
                            </ul>
